-- Setup Status Update System Database Components (FINAL CORRECTED VERSION)
-- This script uses the correct enum types and matches existing schema
...
-- 9. CREATE the get_available_admin_staff function
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '🎯 Enum Types Used:';
  RAISE NOTICE '   ✅ activity_type (grievance_created, grievance_status_changed, etc.)';
  RAISE NOTICE '   ✅ activity_visibility (public, internal, system)';
  RAISE NOTICE '';
