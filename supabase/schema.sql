...
CREATE TRIGGER update_student_transport_profiles_updated_at BEFORE UPDATE ON student_transport_profiles FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
